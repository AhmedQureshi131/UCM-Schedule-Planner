...
if(isset($_POST["emailto"])&&isset($_POST['emailfrom'])){
  ...
  try {
      ...
      $mail->addReplyTo('no-reply@ucmo.edu', 'University of Central Missouri');


      // Content
      $url = "http://" . $_SERVER["HTTP_HOST"]. "/SMS/studentLogin.php";
      $mail->isHTML(true);                                  // Set email format to HTML
      $mail->Subject = 'UCM Schedule Planner';
      $mail->Body    = "<center><h2>University of Central Missouri <br>Go Mules and Jennes!!<br>You Are Invited To Join UCM Schedule Planner </h2></center>
                         $cmnt <br>
...
<!-- if you want to store the image remember type enctype -->
  ...
  <table width="100%" border="6" style="margin-top:100px; left:80%;">
     ...
     <tr >
       <th>Message:</th>
       <td><textarea name="comment" placeholder="Enter Your Comment Here ..." style="width:100%;"></textarea></td>
     </tr>
