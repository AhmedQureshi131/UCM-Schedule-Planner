...
#myBtn:hover {
  ...
  <br><center><h1>  Update Your Schedule</h1></center>
  <form action="planner3.php" method="POST">
       ...
       if(mysqli_num_rows($run) < 1){
        ...
        $count = 0;
         while($data=mysqli_fetch_assoc($run)){
          ...
          <td><a href="deleteform.php?sid=<?php echo $data['id']; ?>" style="color:red;">Drop</a></td>
